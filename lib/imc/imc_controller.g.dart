...
mixin _$ImcController on ImcControllerBase, Store {
  Computed<bool>? _$hasErroComputed;

  @override
  bool get hasErro => (_$hasErroComputed ??= Computed<bool>(() => super.hasErro,
          name: 'ImcControllerBase.hasErro'))
      .value;
  ...
  @override
  Future<void> calcularImc({required double altura, required double peso}) {
    return _$calcularImcAsyncAction
        .run(() => super.calcularImc(altura: altura, peso: peso));
  }
